...
# Massive.com MCP Server
 ...
 [![GitHub release](https://img.shields.io/github/v/release/mobatmedia/mcp_massive)](https://github.com/mobatmedia/mcp_massive/releases)

A [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) server that provides access to
[Massive.com](https://massive.com?utm_campaign=mcp&utm_medium=referral&utm_source=github) financial
market data API through an LLM-friendly interface.

## Overview

This server exposes all Massive.com API endpoints as MCP tools, providing access to comprehensive
...
```bash
# Claude CLI
claude mcp add massive -e MASSIVE_API_KEY=your_api_key_here -- uvx --from git+https://github.com/mobatmedia/mcp_massive@v0.5.1 mcp_massive
```
...
```json
{
    "mcpServers": {
        "massive": {
            ...
            "args": [
                "--from",
                "git+https://github.com/mobatmedia/mcp_massive@v0.5.1",
                "mcp_massive"
            ],
            "env": {
